...
conversation_history_wrong = supabase.table('webChat').select("*").order('id', desc=True ).limit(5).execute()
conversation_history = reversed(conversation_history_wrong.data)
